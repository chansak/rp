var documentListForManager = new function () {
    var documents = [];
    var message = {
        info: {
    ...
    var _edit = function () {
        ...
        if (itemId != 0) {
            window.location.href = '../../Manager/Document/Edit/' + itemId;
        }
    };
    ...
    var _request = function (callback) {
        ...
        if (id != 0) {
            ...
            var xhr = RPService.RequestApprovalForManager(id,success, failure);
        }
    };
    ...
    var _gotPO = function (callback) {
        ...
        if (id != 0) {
            _gotPOValidation(id, function () {
                ...
                var xhr = RPService.GotPOForManager(id, success, failure);
            });       
